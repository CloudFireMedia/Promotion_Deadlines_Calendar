...
//function getSheets_ThreeDayReminder() {
...
//      {
//        CheckSheetThreeDay(sheet,emailOfStaff,'Yes',sheetName);              
//      }
...
//            body = body.replace("{recipient}", bSheet.getName()+"<br> cc "+arr[1]+", Team Leader");
//            body = body.replace("{spreadsheetUrl}", spreadsheetUrl + "#gid=" + bSheet.getSheetId());
//            
//            MailApp.sendEmail({
...
//            body = body.replace("{event date}", Utilities.formatDate(eventdate,"GMT-5", "MM.dd"));
//            body = body.replace("{promotion deadline}", Utilities.formatDate(date,"GMT-5", "MM.dd"));
//            body = body.replace("{recipient}", bSheet.getName());
//            body = body.replace("{spreadsheetUrl}", spreadsheetUrl + "#gid=" + bSheet.getSheetId());
//            
//            MailApp.sendEmail({
//              name:"communications@ccnash.org",
