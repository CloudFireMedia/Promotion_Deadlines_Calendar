function calendar_formatSheet(){//menu
  calendar_colorBorders();
  calendar_setWeeksFormat();
  calendar_setEventsFormat();
  calendar_removeEmptyRows();
  calendar_hideRows();
}
...
function calendar_hideRows() { //menu
